...
- Automated weekday market-data snapshot generated by GitHub Actions, avoiding browser-side Yahoo blocking
- Large-cap universe screener covering up to 100 stocks with freshness checks, ranked candidates, a 50% portfolio deployment cap, and live-data-only recommendations
...
- `scripts/refresh_market_data.py` and `.github/workflows/refresh-market-data.yml` — automated daily dataset
- `market-data/universe.json` — generated market snapshot (created by the workflow)
